...
import "github.com/xchain/go-chain/middleware/notify"
...
// It can meet most of demands abort core event
...
func AsDefault(message notify.Message) *DefaultMessage {
	return message.(*DefaultMessage)
}

type ConsoleMsg string

func (msg ConsoleMsg) GetRaw() []byte {
	return nil
}

func (msg ConsoleMsg) GetData() interface{} {
	return string(msg)
}
