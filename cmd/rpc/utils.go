...
// isContextType returns an indication if the given t is of global.Context or *global.Context type
...
// isPubSub tests whether the given method has as as first argument a global.Context
